package com.macwap.rdxrasel.flowtextview;
...
import com.macwap.rdxrasel.flowtextview.helpers.ClickHandler;
import com.macwap.rdxrasel.flowtextview.helpers.CollisionHelper;
import com.macwap.rdxrasel.flowtextview.helpers.PaintHelper;
import com.macwap.rdxrasel.flowtextview.helpers.SpanParser;
import com.macwap.rdxrasel.flowtextview.listeners.OnLinkClickListener;
import com.macwap.rdxrasel.flowtextview.models.HtmlLink;
import com.macwap.rdxrasel.flowtextview.models.HtmlObject;
import com.macwap.rdxrasel.flowtextview.models.Line;
import com.macwap.rdxrasel.flowtextview.models.Obstacle;
...
public class FlowTextView extends RelativeLayout {
    ...
    public static int mTextColor = Color.BLACK;
    private Typeface typeFace;
    private int mDesiredHeight = 1000; // height of the whole view
    ...
    private int findBoxesAndReturnLowestObstacleYCoord() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() != View.GONE) {
                ...
                obstacle.bottomRighty = obstacle.topLefty + child.getHeight()-55- + layoutParams.bottomMargin; // padding should probably be included as well
