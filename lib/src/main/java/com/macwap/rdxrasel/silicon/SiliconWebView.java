package com.macwap.rdxrasel.silicon;
...
public class SiliconWebView extends WebView {
    ...
    public static final String TAG = SiliconWebView.class.getSimpleName();
    ...
    public SiliconWebView(Context context) {
        super(context);
        init(context);
    }

    public SiliconWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SiliconWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setListenerDuplicate(final Fragment fragment, final Listener listener) {
        setListener(fragment, listener, REQUEST_CODE_FILE_PICKER);
    }
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, SiliconWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
    ...
    protected void onScrollChanged(final int l, final int t, final int oldl, final int oldt)
    {
        ...
        if (onScrollListener != null) {
            onScrollListener.onScrollChanged(isAtTop);
        }
    }
    ...
    public interface OnScrollListener {
        void onScrollChanged(boolean isAtTop);
    }
}